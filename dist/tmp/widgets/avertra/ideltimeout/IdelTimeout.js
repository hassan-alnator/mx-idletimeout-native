...
function _iterableToArrayLimit(arr,i){var _i=arr&&(typeof Symbol!=="undefined"&&arr[Symbol.iterator]||arr["@@iterator"]);if(_i==null)return;var _arr=[];var _n=true;var _d=false;var _s,_e;try{for(_i=_i.call(arr);!(_n=(_s=_i.next()).done);_n=true){_arr.push(_s.value);if(i&&_arr.length===i)break;}}catch(err){_d=true;_e=err;}finally{try{if(!_n&&_i["return"]!=null)_i["return"]();}finally{if(_d)throw _e;}}return _arr;}module.exports=_iterableToArrayLimit;module.exports["default"]=module.exports,module.exports.__esModule=true;
...
var _interopRequireDefault=__webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "./node_modules/@babel/runtime/helpers/interopRequireDefault.js");Object.defineProperty(exports,"__esModule",{value:true});exports.IdleTracker=void 0;var _extends2=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/extends */ "./node_modules/@babel/runtime/helpers/extends.js"));var _slicedToArray2=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ "./node_modules/@babel/runtime/helpers/slicedToArray.js"));var _react=__webpack_require__(/*! react */ "react");var _reactNative=__webpack_require__(/*! react-native */ "react-native");var _storage=__webpack_require__(/*! ../utils/storage */ "./src/utils/storage.js");var _Alert=__webpack_require__(/*! ./Alert */ "./src/components/Alert.jsx");var _this=this,_jsxFileName="D:\\Mendix\\ABL Mobile Banking Solution-main\\CustomWidgets\\idelTimeout\\src\\components\\IdleTracker.jsx";var IdleTracker=function IdleTracker(props){var starterTimerId=(0,_react.useRef)(false);var timerId=(0,_react.useRef)(false);var warningTimerid=(0,_react.useRef)(false);var _useState=(0,_react.useState)(false),_useState2=(0,_slicedToArray2.default)(_useState,2),visible=_useState2[0],setVisible=_useState2[1];var _useState3=(0,_react.useState)((props.minutes||5)*60*1000),_useState4=(0,_slicedToArray2.default)(_useState3,2),timeForInactivityInSecond=_useState4[0],setTimeForInactivityInSecond=_useState4[1];var _useState5=(0,_react.useState)(new Date()),_useState6=(0,_slicedToArray2.default)(_useState5,2),lastTick=_useState6[0],setLastTick=_useState6[1];(0,_react.useEffect)(function(){var keyboardDidShowListener=_reactNative.Keyboard.addListener('keyboardDidShow',function(){clearTimeout(timerId.current);clearTimeout(warningTimerid.current);});var keyboardDidHideListener=_reactNative.Keyboard.addListener('keyboardDidHide',function(){resetInactivityTimeout();});(0,_storage.didBaseTrackerStartBefore)().then(function(tid){if(!tid){resetInactivityTimeout();}else{var _tid$split=tid.split("|"),_tid$split2=(0,_slicedToArray2.default)(_tid$split,2),trid=_tid$split2[0],wid=_tid$split2[1];clearTimeout(parseInt(trid));clearTimeout(parseInt(wid));resetInactivityTimeout();}});return function(){clearTimeout(timerId.current);clearTimeout(warningTimerid.current);clearTimeout(starterTimerId.current);keyboardDidHideListener.remove();keyboardDidShowListener.remove();};},[]);var panResponder=(0,_react.useRef)(_reactNative.PanResponder.create({onStartShouldSetPanResponderCapture:function onStartShouldSetPanResponderCapture(){setTimeout(function(){setLastTick(new Date());},500);resetInactivityTimeout();}})).current;var resetInactivityTimeout=function resetInactivityTimeout(){clearTimeout(timerId.current);clearTimeout(warningTimerid.current);clearTimeout(starterTimerId.current);timerId.current=setTimeout(function(){if(props.warnUser){setVisible(true);}warningTimerid.current=setTimeout(function(){setVisible(false);props.onTimeOut();resetInactivityTimeout();},(props.secondsAfterWarning||5)*1000);},timeForInactivityInSecond);(0,_storage.setBaseTrackerToStarted)(timerId.current+"|"+warningTimerid.current);};var onYesPress=function onYesPress(){var now=new Date();var diff=now.getTime()-lastTick.getTime();var diffMins=Math.round(diff/60000);if(diffMins>props.minutes+1){props.onTimeOut();}else{setVisible(false);}};return(0,_react.createElement)(_reactNative.View,(0,_extends2.default)({style:{flex:1}},panResponder.panHandlers,{__self:_this,__source:{fileName:_jsxFileName,lineNumber:105,columnNumber:5}}),visible&&(0,_react.createElement)(_Alert.Alert,{text:props.warningText.value,onPress:function onPress(){return onYesPress();},buttonColor:props.buttonColor,__self:_this,__source:{fileName:_jsxFileName,lineNumber:106,columnNumber:19}}),props.content);};exports.IdleTracker=IdleTracker;
...
var _interopRequireDefault=__webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "./node_modules/@babel/runtime/helpers/interopRequireDefault.js");Object.defineProperty(exports,"__esModule",{value:true});exports.didBaseTrackerStartBefore=exports.setBaseTrackerToStarted=void 0;var _regenerator=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js"));var _reactNative=__webpack_require__(/*! react-native */ "react-native");var setBaseTrackerToStarted=function setBaseTrackerToStarted(timerId){return _regenerator.default.async(function setBaseTrackerToStarted$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.prev=0;_context.next=3;return _regenerator.default.awrap(_reactNative.AsyncStorage.setItem('@idleTimeOut:base',timerId));case 3:_context.next=7;break;case 5:_context.prev=5;_context.t0=_context["catch"](0);case 7:case"end":return _context.stop();}}},null,null,[[0,5]],Promise);};exports.setBaseTrackerToStarted=setBaseTrackerToStarted;var didBaseTrackerStartBefore=function didBaseTrackerStartBefore(){var value;return _regenerator.default.async(function didBaseTrackerStartBefore$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.prev=0;_context2.next=3;return _regenerator.default.awrap(_reactNative.AsyncStorage.getItem('@idleTimeOut:base'));case 3:value=_context2.sent;if(!(value!==null)){_context2.next=6;break;}return _context2.abrupt("return",value);case 6:return _context2.abrupt("return",false);case 9:_context2.prev=9;_context2.t0=_context2["catch"](0);case 11:case"end":return _context2.stop();}}},null,null,[[0,9]],Promise);};exports.didBaseTrackerStartBefore=didBaseTrackerStartBefore;
